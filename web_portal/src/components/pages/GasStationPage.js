...
export default function GasStationPage() {
  ...
  return (
    <Container maxW="container.xl" py={8}>
      ...
      <Heading size="xl" mb={6}>Gas Station</Heading>
      ...
      {!isConnected ? (
        ...
        <Tabs colorScheme="synergy" isLazy>
          <TabList>
            <Tab><Icon as={FaGasPump} mr={2} /> Purchase Gas</Tab>
            <Tab><Icon as={FaTint} mr={2} /> Testnet Faucet</Tab>
            <Tab><Icon as={FaHistory} mr={2} /> Request History</Tab>
          </TabList>
                ...
                <CardBody>
                  <VStack spacing={6} align="stretch">
                    ...
                    <Box p={4} bg="gray.50" borderRadius="md" _dark={{ bg: 'gray.700' }}>
                      <Heading size="sm" mb={4}>Transaction Summary</Heading>
                      <SimpleGrid columns={2} spacing={4}>
                        <Text>Payment:</Text>
                        <Text fontWeight="bold">{purchaseAmount || '0'} {paymentMethod.toUpperCase()}</Text>
                        
                        <Text>Exchange Rate:</Text>
                        <Text fontWeight="bold">1 {paymentMethod.toUpperCase()} = {getExchangeRate()} SYN</Text>
                  ...
                  <VStack spacing={6} align="stretch">
                    <Alert status="info" borderRadius="md">
                      ...
                      <Box flex="1">
                        ...
                        <AlertDescription>
                          Request free Synergy testnet tokens for development and testing purposes.
                          Limited to 10 SYN per request with a 24-hour cooldown period.
                        </AlertDescription>
                      </Box>
                    </Alert>
                    ...
                    <Box p={4} bg="gray.50" borderRadius="md" _dark={{ bg: 'gray.700' }}>
                      <SimpleGrid columns={{ base: 1, md: 3 }} spacing={6}>
                        <Stat>
                          ...
                          <StatNumber>{account ? `${account.substring(0, 6)}...${account.substring(account.length - 4)}` : 'Not connected'}</StatNumber>
                          <StatHelpText>
                    ...
                    {faucetCooldown ? (
                      <Box p={4} bg="orange.50" borderRadius="md" _dark={{ bg: 'orange.900' }}>
                        <VStack spacing={3} align="stretch">
                          <Heading size="sm" color="orange.500">Cooldown Period Active</Heading>
                          <Text>You can request more tokens in {cooldownTime} hours.</Text>
                          <Progress value={(24 - cooldownTime) / 24 * 100} colorScheme="orange" borderRadius="md" />
                        </VStack>
                      </Box>
                    ) : (
                      <Button 
                        ...
                        >
                          <SimpleGrid columns={{ base: 1, md: 4 }} spacing={4}>
                            ...
                            <Box>
                              ...
                              <Badge colorScheme={request.status === 'Completed' ? 'green' : 'yellow'}>
                                {request.status}
                              </Badge>
                            </Box>
                            <Box>
